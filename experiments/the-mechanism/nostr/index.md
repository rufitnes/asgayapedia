...
**Next:** [Notification Bot](notification-bot.md) — How it runs automatically  
**Related:** [Bulletin Board](bulletin-board.md) — Where sellers are discovered  
**Related:** [Wallet](wallet.md) — Where Nostr keys are generated
