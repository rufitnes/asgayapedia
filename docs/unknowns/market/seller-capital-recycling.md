...
1. Model capital flow timing: payment → covenant → claim → recycle
2. Identify bottlenecks (payment confirmation, claim coordination, liquidity)
3. Measure actual recycling rates in Phase 0
4. Interview sellers about practical constraints
