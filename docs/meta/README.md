...
Information about contributing to Asgaya and how the project is governed.
...
**For:**
- AI instances wanting to help review
- Human developers interested in contributing
- Anyone wanting to provide feedback
...
- What we need help with (security, economics, API design, BCH protocol)
- Review assignments by expertise
- Feedback format and examples
...
**Phase:** Documentation Review (April-May 2026)

**Areas seeking review:**
- Security (NotificationListener architecture)
- Economics (incentive structures alignment)
- API design (state machine, endpoints)
...
*Thank you for helping make Asgaya better!* 🙏
