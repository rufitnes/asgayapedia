...
**Mode:** Passive - posts listing once, bot handles everything automatically
...
1. **Download Asgaya Wallet**
   ...
   - Generate BCH wallet
   - Create Cash Account: `Carlos#879`

2. **Post Listing on Bulletin Board**
   - Amount: Up to €500 per day
   - Rate: 0.5% fee (Carlos buys BCH for 99.5% of spot price)
   - Payment method: VES cash at store
   - Location: Av. Libertador 123, Caracas
   - Hours: Mon-Sat 8am-8pm

3. **Enable Notification Bot**
   - Bot monitors bulletin board for matches
   - Auto-notifies Carlos when someone wants to sell BCH nearby
   - Carlos can accept/reject each trade
...
#### Morning: Bot Finds Elena

- Elena receives €100 from María
- Elena's app queries bulletin board: "Who buys BCH in Caracas?"
- Bot matches Elena to Carlos's listing
- Carlos gets notification: "Elena wants to sell €100 BCH. Accept?"

#### Carlos Reviews & Accepts

- Carlos checks notification (30 seconds)
- Sees: Elena#142, €100, good reputation (4.8★)
- Taps "Accept"
- Bot coordinates via Nostr: "Come to my store at Av. Libertador 123"

#### Elena Arrives at Store (15 Minutes Later)

- Elena: "Hi, I'm here to sell €100 BCH"
- Carlos: "Great, I'll give you 45,000 VES. Want to buy groceries?"
- Elena: "Yes, I need rice, beans, and oil"
...
1. **Trade Execution**
   ...
   - Elena taps "Release to Carlos#879"
   - Carlos taps "Confirm receipt and pay Elena"
   - BCH moves to Carlos's wallet
   - Carlos hands Elena 45,000 VES cash

2. **The Upsell** (This is where triple-dip shines)
   - Elena spends 30,000 VES on groceries (she came to buy anyway)
   - Carlos earns 15-30% margin on those products
   - Elena saves trip to separate store
   - Carlos converts her from BCH seller to grocery customer
...
**With Asgaya:**
- Elena receives BCH instantly (no Western Union)
- Elena goes directly to Carlos's store (one trip)
- Elena trades BCH for cash at Carlos's store
...
"Holy shit, I'm hedging hyperinflation."

- VES inflates 40% over 3 months
- Carlos's BCH holdings worth 40% more in local terms
- Rent is now effectively cheaper (paid in depreciated VES)
- Carlos realizes: **BCH is better savings than VES**

### The Addiction (Month 6)

"This is my retirement fund."

- Carlos accumulates €5,000 in BCH + H€ + HAu
- Traditional bank savings: -40% real value (VES inflation)
- Carlos's crypto savings: +20% real value (BCH appreciation + hedge)
- **Carlos evangelizes:** Tells other merchants to join
...
**This is the endgame:** Merchant adoption → direct BCH payments → Asgaya disappears.
...
- Bot monitors bulletin board
- Auto-notifies when match found
- Carlos just accepts/rejects (30 seconds)
- **Carlos earns money while sleeping**

### Scaling Without Effort

**Month 1:** 5 transactions/week (active mode, learning)  
**Month 3:** 20 transactions/week (passive mode, bot handling)  
**Month 6:** 50 transactions/week (bot + reputation, auto-accept trusted users)  
...
3. **Merchant exemption:** Carlos is providing goods/services, not money transmitter
...
[Passive Income Loop]
  ↓
1. Bot detects Elena wants to sell €100 BCH
  ↓
2. Carlos gets notification: "Elena#142 wants to sell €100. Accept?"
  ↓
3. Carlos taps "Accept" (30 seconds)
  ↓
4. Bot coordinates via Nostr: "Come to Av. Libertador 123"
  ↓
5. Elena arrives at store (Carlos is already there working)
  ↓
6. Trade: Elena shows wallet → Carlos verifies → Both tap confirm → BCH moves
  ↓
7. Carlos hands Elena 45,000 VES cash
  ↓
8. Elena: "Can I buy groceries?" → Carlos: "Of course!" (upsell)
  ↓
9. Elena spends 30,000 VES on groceries (Carlos earns margin)
  ↓
10. Rate each other → Done
  ↓
[Repeat 5-10 times per day, automated]
```
...
- [Wallet](/reference/android-app/wallet/) - Accept trades, manage stability tokens
- [Bulletin Board](/reference/android-app/bulletin-board/) - Post passive listings
- [Nostr](/reference/android-app/nostr/) - Coordinate with recipients
- [Notification Bot](/reference/android-app/notification-bot/) - Auto-match trades
- [Stability Layer](/reference/android-app/stability/) - H€/HAu conversion

**For rationale, see:**
- [Why Merchants Matter](/why-this-design/requirements/merchant-adoption/)
- [Why Triple-Dip Works](/why-this-design/evidence/merchant-retention/)
- [Why Stability Layer](/why-this-design/constraints/volatility/)
...
**Related journeys:**
- [Sender Journey](/user-journeys/sender/) - Where remittances come from
- [Recipient Journey](/user-journeys/recipient/) - Elena's perspective
- [Trader Journey](/user-journeys/trader/) - Scaling to Pro Seller
