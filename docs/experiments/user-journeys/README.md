...
**Everything collapses into this:** Some people have BCH and want fiat. Some people have fiat and want BCH. The bulletin board connects them. Covenants execute the trades. Nostr coordinates. Bots automate.
...
### Passive Users (Post Listings, Bot Automates)

- Post a listing once.
- The bot handles requests 24/7.
...
- **No central coordinator:** Passive bots provide 24/7 liquidity; active users always find counterparties. The market self‑organizes.
...
María sends €100 to Elena. She opens the app, enters `Elena#142`, selects the cheapest seller, and pays via Bizum. The bot handles the rest. Elena gets a notification, decides to cash out, picks the nearest merchant from the bulletin board, walks over, gets cash, and buys groceries. Both are pure active users—no listings needed.
...
Roberto mines BCH. He posts a listing and lets the bot sell his mined coins directly to senders, avoiding exchange fees entirely. Fully passive, zero extra work.
...
| **Merchant** (Carlos) | Usually Passive | Posts as buyer, bot handles recipients, accumulates BCH |
| | Sometimes Active | Queries buyers, sells accumulated BCH for bolívars |
| **Seller** (Isabel/Roberto) | Usually Passive | Posts as seller, bot handles senders, earns fees |
| | Could be Active | If they needed BCH urgently, could query buyers |

---

## Phase 0 Expectations (Spain → Venezuela)
...
**Success:** At least 5 passive sellers online 24/7; at least 15 passive merchants in Caracas. Active users always see 3+ options, and response times are under 1 minute.

---

## How Active & Passive Use the Four Gears

**Active Mode:** Wallet → Bulletin Board (query) → Nostr (coordination) → Covenant (transaction). User experience is like a price comparison site plus a payment app.

**Passive Mode:** Wallet → Bulletin Board (post listing) → Bot monitors Nostr, bank notifications, and blockchain → Bot auto‑responds and funds covenants. User experience is like a vending machine—stock once, check revenue later.
...
3. **Bots make passive mode possible.** 24/7 liquidity, no human attention required.
...
When someone asks, *“What is Asgaya?”* — it’s a bulletin board where passive bots provide 24/7 liquidity and active users pick the best offer. Covenants make it safe; Bitcoin Cash makes it cheap and permissionless.

---

**Next:** [How They Interact](how-they-interact.md) — End‑to‑end walkthrough  
**Related:** [Bulletin Board](bulletin-board.md), [Notification Bot](notification-bot.md), [Wallet](wallet.md)
