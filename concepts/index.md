...
### [Overcollateralized Bounty Contracts](concepts/overcollateralized-bounty-contracts.md)
...
### [Core Regulatory Constraints](concepts/core-regulatory-constraints.md)
...
### [BCH Buyers](concepts/bch-buyers.md) ⚠️ **Phase 1.1+**
...
### [RFID Card Recipients](concepts/rfid-card-recipients.md) ⚠️ **Phase 1+**
...
### [Dynamic Reward Modulation](concepts/dynamic-reward-modulation.md) ⚠️ **Deferred**
...
### [Bubble Prevention](concepts/bubble-prevention.md) ⚠️ **Deferred**
Proposed mechanisms to prevent speculative behavior in reward systems. Not implemented in Phase 0 (trusted parties only).

### [Market Making Partners](concepts/market-making-partners.md) ⚠️ **Obsolete (Pre-Covenant)**
...
**Start with:** [Overcollateralized Bounty Contracts](concepts/overcollateralized-bounty-contracts.md) - the covenant mechanism that makes everything else possible.
